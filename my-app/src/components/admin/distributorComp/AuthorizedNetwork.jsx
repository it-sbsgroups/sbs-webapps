...
export default function AuthorizedNetwork() {
  ...
  useEffect(() => {
    siteConfigApi
      ...
      .catch((err) => console.warn("Failed to load distributor data:", err))
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-900">Distributor Page – Why Choose Us</h2>
        <p className="mt-1 text-sm text-slate-500">Manage the "Why Choose Our Authorized Network?" section.</p>
      </div>
